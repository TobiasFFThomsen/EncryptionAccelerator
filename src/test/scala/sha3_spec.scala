...
class roundAndBuffer_tester(dut: RoundAndBuffer) extends PeekPokeTester(dut) {
  poke(dut.io.round_out_0_0,0x000008000000000dL)
  poke(dut.io.round_out_0_1,0x0000000000000000L)
  poke(dut.io.round_out_0_2,0x0000000000000000L)
  poke(dut.io.round_out_0_3,0x0000000000000000L)
  poke(dut.io.round_out_0_4,0x0000000000000000L)

  poke(dut.io.round_out_1_0,0x0000000000000000L)
  poke(dut.io.round_out_1_1,0x0000000000000000L)
  poke(dut.io.round_out_1_2,0x0000000000000000L)
  poke(dut.io.round_out_1_3,0x8000000000008000L)
  poke(dut.io.round_out_1_4,0x0000000000000000L)

  poke(dut.io.round_out_2_0,0x0000000000000000L)
  poke(dut.io.round_out_2_1,0x0000000000000000L)
  poke(dut.io.round_out_2_2,0x0000000000000000L)
  poke(dut.io.round_out_2_3,0x0000000000000000L)
  poke(dut.io.round_out_2_4,0x0000000000000000L)

  poke(dut.io.round_out_3_0,0x000000000000000dL)
  poke(dut.io.round_out_3_1,0x0000000000000000L)
  poke(dut.io.round_out_3_2,0x0000000000000000L)
  poke(dut.io.round_out_3_3,0x0000000000000000L)
  poke(dut.io.round_out_3_4,0x0000000000000000L)

  poke(dut.io.round_out_4_0,0x0000000000000000L)
  poke(dut.io.round_out_4_1,0x0000000000000000L)
  poke(dut.io.round_out_4_2,0x0000000000000000L)
  poke(dut.io.round_out_4_3,0x0000000000000000L)
  poke(dut.io.round_out_4_4,0x0000000000000000L)

  poke(dut.io.stateReg_enable, true.B)
  /*
...
class sha3_spec extends FlatSpec with Matchers {
  "THETA" should "pass" in {
    chisel3.iotesters.Driver(() => new RoundAndBuffer()) { c => new roundAndBuffer_tester(c)} should be (true)
  }
}
