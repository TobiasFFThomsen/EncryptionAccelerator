...
class StateRegister extends Module {
  ...
  val state_2_0_reg = RegInit(0.U)
  val state_3_0_reg = RegInit(0.U)
  val state_0_0_reg = RegInit(0.U)
  val state_1_0_reg = RegInit(0.U)
  val state_4_0_reg = RegInit(0.U)

  val state_0_1_reg  = RegInit(0.U)
  val state_1_1_reg  = RegInit(0.U)
  val state_2_1_reg  = RegInit(0.U)
  val state_3_1_reg  = RegInit(0.U)
  val state_4_1_reg  = RegInit(0.U)

  val state_0_2_reg  = RegInit(0.U)
  val state_1_2_reg  = RegInit(0.U)
  val state_2_2_reg  = RegInit(0.U)
  val state_3_2_reg  = RegInit(0.U)
  val state_4_2_reg  = RegInit(0.U)

  val state_0_3_reg  = RegInit(0.U)
  val state_1_3_reg  = RegInit(0.U)
  val state_2_3_reg  = RegInit(0.U)
  val state_3_3_reg  = RegInit(0.U)
  val state_4_3_reg  = RegInit(0.U)

  val state_0_4_reg  = RegInit(0.U)
  val state_1_4_reg  = RegInit(0.U)
  val state_2_4_reg  = RegInit(0.U)
  val state_3_4_reg  = RegInit(0.U)
  val state_4_4_reg  = RegInit(0.U)
  ...
  io.state_out_0_0 := state_2_0_reg
  io.state_out_1_0 := state_3_0_reg
  io.state_out_2_0 := state_0_0_reg
  io.state_out_3_0 := state_1_0_reg
