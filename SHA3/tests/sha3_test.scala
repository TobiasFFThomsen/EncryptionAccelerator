...
class sha_test_(dut: Sha3) extends PeekPokeTester(dut)  {
...
class sha3_test extends FlatSpec with Matchers {
  "sha3" should "pass" in {
    chisel3.iotesters.Driver(() => new Sha3()) { c => new sha_test_(c)} should be (true)
  }
}
